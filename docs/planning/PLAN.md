...
- `docs/planning/ROADMAP.md` — `v0.30` and `v0.30f` moved to Completed Releases; `v0.30` becomes the current completed release; Next Planned Work now leads with `v0.30.1` and `v0.31` (per the sequencing agreement to take the discovery task bridge before the symmetry-method registry).
