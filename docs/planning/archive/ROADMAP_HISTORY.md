...
> Historical archive. This file preserves the detailed roadmap before the compact planning split. The current authoritative planning summary is `../ROADMAP.md`.
