...
```bash
python -m pip install "git+https://github.com/alexgabel/pdelie.git@v0.38.0b1"
python -m pip install "git+https://github.com/alexgabel/pdelie.git@v0.38.0b1#egg=pdelie[pdebench]"       # optional PDEBench cookbook extra (h5py)
python -m pip install "git+https://github.com/alexgabel/pdelie.git@v0.38.0b1#egg=pdelie[downstream]"    # optional PySINDy bridge extra
```
